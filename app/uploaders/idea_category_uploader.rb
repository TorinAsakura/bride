# encoding: utf-8
class IdeaCategoryUploader < BaseImageUploader
  def store_dir
    "uploads/ideas/categories/#{model.id}"
  end
  ...
  version :preview do
    process resize_and_crop: [480, 480]
  end

  version :gray_thumb, from_version: :thumb do
    process make_gray: nil
  end
  version :gray_preview, from_version: :preview do
    process make_gray: nil
  end
